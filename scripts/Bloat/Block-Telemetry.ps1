...
#
# Only the safest domains have been added, but as with anything there may be bugs or some applications
# may misbehave.  Simply edit your hosts file if tweaks are needed.
#
